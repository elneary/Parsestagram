...
- [x] User sees error prompt for login/signup mistake. 
- [x] Styled post creation page and login page with Instagram assets.
- [x] Description entry field not visible until valid photo is taken. 
